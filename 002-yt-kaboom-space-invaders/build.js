(() => {
  ...
  var Nt = (i, t, l) => t in i ? rr(i, t, { enumerable: true, configurable: true, writable: true, value: l }) : i[t] = l;
  var P = (i, t) => {
    for (var l in t || (t = {}))
  ...
  var D = (i, t) => Hi(i, zi(t));
  var a = (i, t) => rr(i, "name", { value: t, configurable: true });
  ...
  var be = class {
    ...
    gen(...t) {
      if (t.length === 0)
        return this.seed = (Zi * this.seed + es) % pr, this.seed / pr;
      if (t.length === 1) {
...
`;
  ...
  var no = a((i = {}) => {
    ...
    function j(e) {
      let n = new Image();
      return n.src = ur(e) ? e : U.urlPrefix + e, n.crossOrigin = "anonymous", new Promise((r, u) => {
...
`)
    ...
    function Re(e, n, r, u, c, s = 1) {
      u = ue(u % 360), c = ue(c % 360), c <= u && (c += Math.PI * 2);
      ...
      if (!(n < 3)) {
        if (re(), I(e.pos), ne(e.scale), Je(e.angle), I(e.offset), e.fill !== false) {
          let c = (r = e.color) != null ? r : v.WHITE, s = e.pts.map((d) => {
            var h;
            return { pos: ce(d.x, d.y, 0), uv: f(0, 0), color: c, opacity: (h = e.opacity) != null ? h : 1 };
...
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
    ...
    a(Lt, "toWorld");
    function En(e) {
      let n = /* @__PURE__ */ new Map(), r = {}, u = {}, c = { _id: cr(), hidden: false, paused: false, children: [], parent: null, add(s) {
        if (this !== p.root)
    ...
    function It(e = {}) {
      ...
      return { id: "outview", require: ["pos", "area"], isOutOfView() {
        var s;
        let u = f((s = e.offset) != null ? s : 0), c = new _e(f(0, 0).sub(u), f(F(), G()).add(u));
        return !wt(this.screenArea(), c);
      }, onExitView(u) {
    ...
    function fi(e = {}) {
      ...
      return { id: "area", add() {
        ...
        return gt(this.worldArea(), c);
      }, pushOut(c) {
        var g;
        if (c === this || ((g = c.area) == null ? void 0 : g.shape) !== "rect")
          return null;
        let s = this.worldArea(), o = c.worldArea(), d = Ut(s, o);
        if (!ae(d, f(0)))
          return null;
    ...
    function Ci(e, n = {}) {
      ...
      return { id: "lifespan", update() {
        r += Z(), r >= c && (this.opacity = ht(r, c, e, 1, 0)), r >= e && this.destroy();
      } };
    }
    a(Ci, "lifespan");
    function Ri(e, n, r) {
