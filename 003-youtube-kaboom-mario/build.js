...
`), font: U.fonts[rn], pos: f(r, -r), origin: "botleft", size: 16, width: F() * t.scale * 0.6, lineSpacing: r / 2, fixed: true, styles: { time: { color: E(127, 127, 127) }, info: { color: E(255, 255, 255) }, error: { color: E(255, 0, 127) } } });
  ...
  function SceneComeco() {
    ...
    game_default.add([text("Clique para iniciar o jogo"), pos(center()), origin("center")]);
    onClick(() => go("jogo"));
  }
  ...
  // characters/player-collisions.js
  function playerCollisions(mainPlayer, gameLevel2, scoreLabel) {
    mainPlayer.onHeadbutt((obj) => {
      if (obj.is("coin-surprise")) {
        gameLevel2.spawn("$", obj.gridPos.sub(0, 1));
        destroy(obj);
        gameLevel2.spawn("{", obj.gridPos.sub(0, 0));
      }
    ...
    mainPlayer.collides("mushroom", (mushroom2) => {
